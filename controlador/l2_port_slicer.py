...
class PortSliceSwitch (object):
  ...
  def __init__ (self, connection, config):
    ...
    self.transparent = not not config["transparent"]
...
class PortSlicer (object):
  ...
  def __init__ (self, config_file):
    ...
    self.configs = json.load(file(config_file))
  ...
  def _handle_ConnectionUp (self, event):
    ...
    PortSliceSwitch(event.connection, config)
...
def launch (config, hold_down=_flood_delay):
  ...
  core.registerNew(PortSlicer, config)
